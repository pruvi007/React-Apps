        ...
        <nav>
          <div className="row bg-dark text-light">
            ...
            <div className="col-2 mt-1 text-right d-none d-md-block">
              ...
              >
                <Link className="dropdown-item" to="/NCR">NCR</Link>
              <Link className="dropdown-item" to="/Ahmedabad">Ahmedabad</Link>
              <Link className="dropdown-item" to="/Banglore">Banglore</Link>
              <Link className="dropdown-item" to="/Chennai">Chennai</Link>
              <Link className="dropdown-item" to="/Mumbai">Mumbai</Link>
              </div>
            </div>
