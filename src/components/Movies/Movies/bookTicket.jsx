      ...
      <div>
        ...
        <div className="row bg-light pt-2 pb-2">
          <div className="col-lg-5">
            <button className="btn btn-sm btn-light m-1" style={{backgroundColor:"green"}} onClick={()=>this.handleBtnClick()}>
              <b>21 TODAY</b>
            </button>
        ...
        <div className="container col-12">
          ...
          <div className="row border-bottom-1 pt-1">
            ...
            {p.timings.map((x, ind2)=>(
               <Link to={"/NCR/"+movieInd+"/buyTicket/"+ind1+"/"+ind2+"/"+this.state.dateInd.ind+"?time="+this.state.dateInd.value}>
               <button className="btn btn-outline-secondary text-primary btn-sm border-muted m-1"
               onClick={()=>this.props.onBookingDetails(p.name, x.name,p)}
                style={{
                  marginButtom: "12px",
                  maxHeight: "40px",
                  fontSize: "12px",
